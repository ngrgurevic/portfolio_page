...
function About() {
    return <section className="bg-primary text-white mb-0" id="about">
      <div className="container">
        ...
        <div className="text-center mt-4">
          <a className="btn btn-xl btn-outline-light" a href="../images/documents/Nikola_Grgurević_CV.pdf" download='Nikola_Grgurević_CV.pdf'>
